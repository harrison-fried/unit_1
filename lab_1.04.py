...
'''
# Genie Assignment ---
print("Hello i am a great genie, you have three wishes... ask wisely")
a = input("What is your first wish? ")
b = input("What is your second wish? ")
print("one more wish left, chose wisely")
c = input("What is your last wish? ")
print(f"you have wished for {b}, {c}, and {a}")